...
{
  tesseract_msgs__msg__JointLimits * msg = (tesseract_msgs__msg__JointLimits *)malloc(sizeof(tesseract_msgs__msg__JointLimits));
  if (!msg) {
    return NULL;
  }
...
tesseract_msgs__msg__JointLimits__Sequence__init(tesseract_msgs__msg__JointLimits__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tesseract_msgs__msg__JointLimits *)calloc(size, sizeof(tesseract_msgs__msg__JointLimits));
    if (!data) {
      return false;
    }
...
{
  tesseract_msgs__msg__JointLimits__Sequence * array = (tesseract_msgs__msg__JointLimits__Sequence *)malloc(sizeof(tesseract_msgs__msg__JointLimits__Sequence));
  if (!array) {
    return NULL;
  }
