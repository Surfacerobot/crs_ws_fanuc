...
#ifndef REGION_DETECTION_MSGS__SRV__SHOW_SELECTABLE_REGIONS__FUNCTIONS_H_
#define REGION_DETECTION_MSGS__SRV__SHOW_SELECTABLE_REGIONS__FUNCTIONS_H_
...
/// Initialize srv/ShowSelectableRegions message.
/**
...
/// Finalize srv/ShowSelectableRegions message.
/**
...
/// Create srv/ShowSelectableRegions message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * region_detection_msgs__srv__ShowSelectableRegions_Request__init().
...
/// Destroy srv/ShowSelectableRegions message.
/**
 * It calls
 * region_detection_msgs__srv__ShowSelectableRegions_Request__fini()
...
/// Initialize array of srv/ShowSelectableRegions messages.
/**
...
/// Finalize array of srv/ShowSelectableRegions messages.
/**
 * It calls
 * region_detection_msgs__srv__ShowSelectableRegions_Request__fini()
...
/// Create array of srv/ShowSelectableRegions messages.
/**
 * It allocates the memory for the array and calls
 * region_detection_msgs__srv__ShowSelectableRegions_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ShowSelectableRegions messages.
/**
 * It calls
 * region_detection_msgs__srv__ShowSelectableRegions_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * region_detection_msgs__srv__ShowSelectableRegions_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_region_detection_msgs
...
/**
 * It calls
 * region_detection_msgs__srv__ShowSelectableRegions_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_region_detection_msgs
...
/**
 * It allocates the memory for the array and calls
 * region_detection_msgs__srv__ShowSelectableRegions_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_region_detection_msgs
...
/**
 * It calls
 * region_detection_msgs__srv__ShowSelectableRegions_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // REGION_DETECTION_MSGS__SRV__SHOW_SELECTABLE_REGIONS__FUNCTIONS_H_
