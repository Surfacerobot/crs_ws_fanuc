...
#ifndef UR_DASHBOARD_MSGS__SRV__GET_PROGRAM_STATE__STRUCT_HPP_
#define UR_DASHBOARD_MSGS__SRV__GET_PROGRAM_STATE__STRUCT_HPP_
...
struct GetProgramState_Request_
{
  ...
  explicit GetProgramState_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetProgramState_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
// Member 'state'
#include "ur_dashboard_msgs/msg/program_state__struct.hpp"
...
struct GetProgramState_Response_
{
  ...
  explicit GetProgramState_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : state(_init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
  ...
  explicit GetProgramState_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : state(_alloc, _init),
    program_name(_alloc),
    answer(_alloc)
  {
...
#endif  // UR_DASHBOARD_MSGS__SRV__GET_PROGRAM_STATE__STRUCT_HPP_
