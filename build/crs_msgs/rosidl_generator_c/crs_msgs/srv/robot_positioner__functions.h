...
#ifndef CRS_MSGS__SRV__ROBOT_POSITIONER__FUNCTIONS_H_
#define CRS_MSGS__SRV__ROBOT_POSITIONER__FUNCTIONS_H_
...
/// Initialize srv/RobotPositioner message.
/**
...
/// Finalize srv/RobotPositioner message.
/**
...
/// Create srv/RobotPositioner message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * crs_msgs__srv__RobotPositioner_Request__init().
...
/// Destroy srv/RobotPositioner message.
/**
 * It calls
 * crs_msgs__srv__RobotPositioner_Request__fini()
...
/// Initialize array of srv/RobotPositioner messages.
/**
...
/// Finalize array of srv/RobotPositioner messages.
/**
 * It calls
 * crs_msgs__srv__RobotPositioner_Request__fini()
...
/// Create array of srv/RobotPositioner messages.
/**
 * It allocates the memory for the array and calls
 * crs_msgs__srv__RobotPositioner_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RobotPositioner messages.
/**
 * It calls
 * crs_msgs__srv__RobotPositioner_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * crs_msgs__srv__RobotPositioner_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_crs_msgs
...
/**
 * It calls
 * crs_msgs__srv__RobotPositioner_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_crs_msgs
...
/**
 * It allocates the memory for the array and calls
 * crs_msgs__srv__RobotPositioner_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_crs_msgs
...
/**
 * It calls
 * crs_msgs__srv__RobotPositioner_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CRS_MSGS__SRV__ROBOT_POSITIONER__FUNCTIONS_H_
