...
#ifndef UR_DASHBOARD_MSGS__MSG__PROGRAM_STATE__STRUCT_H_
#define UR_DASHBOARD_MSGS__MSG__PROGRAM_STATE__STRUCT_H_
...
{
  rosidl_generator_c__String state;
...
#endif  // UR_DASHBOARD_MSGS__MSG__PROGRAM_STATE__STRUCT_H_
