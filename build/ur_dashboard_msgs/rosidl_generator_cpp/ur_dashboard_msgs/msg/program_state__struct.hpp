...
#ifndef UR_DASHBOARD_MSGS__MSG__PROGRAM_STATE__STRUCT_HPP_
#define UR_DASHBOARD_MSGS__MSG__PROGRAM_STATE__STRUCT_HPP_
...
struct ProgramState_
{
  ...
  explicit ProgramState_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ProgramState_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : state(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // UR_DASHBOARD_MSGS__MSG__PROGRAM_STATE__STRUCT_HPP_
