...
bool tesseract_msgs__srv__get_environment_information__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tesseract_msgs.srv._get_environment_information.GetEnvironmentInformation_Request",
...
bool tesseract_msgs__srv__get_environment_information__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tesseract_msgs.srv._get_environment_information.GetEnvironmentInformation_Response",
  ...
  {  // link_names
    ...
    if (!rosidl_generator_c__String__Sequence__init(&(ros_message->link_names), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_c__String * dest = ros_message->link_names.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // active_link_names
    ...
    if (!rosidl_generator_c__String__Sequence__init(&(ros_message->active_link_names), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_c__String * dest = ros_message->active_link_names.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // active_joint_names
    ...
    if (!rosidl_generator_c__String__Sequence__init(&(ros_message->active_joint_names), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_c__String * dest = ros_message->active_joint_names.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
PyObject * tesseract_msgs__srv__get_environment_information__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // link_names
    ...
    rosidl_generator_c__String * src = ros_message->link_names.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // active_link_names
    ...
    rosidl_generator_c__String * src = ros_message->active_link_names.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // active_joint_names
    ...
    rosidl_generator_c__String * src = ros_message->active_joint_names.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
