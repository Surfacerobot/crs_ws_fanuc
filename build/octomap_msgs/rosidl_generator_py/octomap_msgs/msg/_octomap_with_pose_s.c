...
bool octomap_msgs__msg__octomap_with_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "octomap_msgs.msg._octomap_with_pose.OctomapWithPose",
        full_classname_dest, 51) == 0);
  }
  octomap_msgs__msg__OctomapWithPose * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of OctomapWithPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("octomap_msgs.msg._octomap_with_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OctomapWithPose");
