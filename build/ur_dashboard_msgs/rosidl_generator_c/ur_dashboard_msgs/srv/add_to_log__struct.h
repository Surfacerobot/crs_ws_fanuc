...
#ifndef UR_DASHBOARD_MSGS__SRV__ADD_TO_LOG__STRUCT_H_
#define UR_DASHBOARD_MSGS__SRV__ADD_TO_LOG__STRUCT_H_
...
#endif  // UR_DASHBOARD_MSGS__SRV__ADD_TO_LOG__STRUCT_H_
