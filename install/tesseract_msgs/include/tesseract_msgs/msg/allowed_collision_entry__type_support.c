...
static rosidl_typesupport_introspection_c__MessageMember AllowedCollisionEntry__rosidl_typesupport_introspection_c__AllowedCollisionEntry_message_member_array[3] = {
  {
    "link_1",  // name
