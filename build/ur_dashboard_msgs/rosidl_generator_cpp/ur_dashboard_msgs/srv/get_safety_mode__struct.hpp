...
#ifndef UR_DASHBOARD_MSGS__SRV__GET_SAFETY_MODE__STRUCT_HPP_
#define UR_DASHBOARD_MSGS__SRV__GET_SAFETY_MODE__STRUCT_HPP_
...
struct GetSafetyMode_Request_
{
  ...
  explicit GetSafetyMode_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetSafetyMode_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
// Member 'safety_mode'
#include "ur_dashboard_msgs/msg/safety_mode__struct.hpp"
...
struct GetSafetyMode_Response_
{
  ...
  explicit GetSafetyMode_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : safety_mode(_init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
  ...
  explicit GetSafetyMode_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // UR_DASHBOARD_MSGS__SRV__GET_SAFETY_MODE__STRUCT_HPP_
