...
#ifndef UR_DASHBOARD_MSGS__SRV__IS_PROGRAM_SAVED__STRUCT_HPP_
#define UR_DASHBOARD_MSGS__SRV__IS_PROGRAM_SAVED__STRUCT_HPP_
...
struct IsProgramSaved_Request_
{
  ...
  explicit IsProgramSaved_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit IsProgramSaved_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct IsProgramSaved_Response_
{
  ...
  explicit IsProgramSaved_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit IsProgramSaved_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : answer(_alloc),
    program_name(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // UR_DASHBOARD_MSGS__SRV__IS_PROGRAM_SAVED__STRUCT_HPP_
