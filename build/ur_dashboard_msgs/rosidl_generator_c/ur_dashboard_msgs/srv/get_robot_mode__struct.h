...
#ifndef UR_DASHBOARD_MSGS__SRV__GET_ROBOT_MODE__STRUCT_H_
#define UR_DASHBOARD_MSGS__SRV__GET_ROBOT_MODE__STRUCT_H_
...
#endif  // UR_DASHBOARD_MSGS__SRV__GET_ROBOT_MODE__STRUCT_H_
