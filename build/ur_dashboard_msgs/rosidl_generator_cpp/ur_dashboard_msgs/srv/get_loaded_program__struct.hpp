...
#ifndef UR_DASHBOARD_MSGS__SRV__GET_LOADED_PROGRAM__STRUCT_HPP_
#define UR_DASHBOARD_MSGS__SRV__GET_LOADED_PROGRAM__STRUCT_HPP_
...
struct GetLoadedProgram_Request_
{
  ...
  explicit GetLoadedProgram_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetLoadedProgram_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct GetLoadedProgram_Response_
{
  ...
  explicit GetLoadedProgram_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit GetLoadedProgram_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : answer(_alloc),
    program_name(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // UR_DASHBOARD_MSGS__SRV__GET_LOADED_PROGRAM__STRUCT_HPP_
