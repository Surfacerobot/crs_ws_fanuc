...
#ifndef OCTOMAP_MSGS__MSG__OCTOMAP_WITH_POSE__STRUCT_HPP_
#define OCTOMAP_MSGS__MSG__OCTOMAP_WITH_POSE__STRUCT_HPP_
...
struct OctomapWithPose_
{
  ...
  explicit OctomapWithPose_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    origin(_init),
    octomap(_init)
  {
  ...
  explicit OctomapWithPose_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    origin(_alloc, _init),
...
#endif  // OCTOMAP_MSGS__MSG__OCTOMAP_WITH_POSE__STRUCT_HPP_
