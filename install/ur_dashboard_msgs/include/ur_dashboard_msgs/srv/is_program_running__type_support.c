...
#include <stddef.h>
#include "ur_dashboard_msgs/srv/is_program_running__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers ur_dashboard_msgs__srv__is_program_running__rosidl_typesupport_introspection_c__IsProgramRunning_service_members = {
  "ur_dashboard_msgs__srv",  // service namespace
  "IsProgramRunning",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // ur_dashboard_msgs__srv__is_program_running__rosidl_typesupport_introspection_c__IsProgramRunning_Request_message_type_support_handle,
  NULL  // response message
  // ur_dashboard_msgs__srv__is_program_running__rosidl_typesupport_introspection_c__IsProgramRunning_Response_message_type_support_handle
};

static rosidl_service_type_support_t ur_dashboard_msgs__srv__is_program_running__rosidl_typesupport_introspection_c__IsProgramRunning_service_type_support_handle = {
  0,
  &ur_dashboard_msgs__srv__is_program_running__rosidl_typesupport_introspection_c__IsProgramRunning_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur_dashboard_msgs, srv, IsProgramRunning)() {
  if (!ur_dashboard_msgs__srv__is_program_running__rosidl_typesupport_introspection_c__IsProgramRunning_service_type_support_handle.typesupport_identifier) {
    ur_dashboard_msgs__srv__is_program_running__rosidl_typesupport_introspection_c__IsProgramRunning_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)ur_dashboard_msgs__srv__is_program_running__rosidl_typesupport_introspection_c__IsProgramRunning_service_type_support_handle.data;
  ...
  return &ur_dashboard_msgs__srv__is_program_running__rosidl_typesupport_introspection_c__IsProgramRunning_service_type_support_handle;
}
