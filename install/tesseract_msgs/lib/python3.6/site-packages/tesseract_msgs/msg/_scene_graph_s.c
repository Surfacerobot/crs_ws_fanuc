...
bool tesseract_msgs__msg__scene_graph__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tesseract_msgs.msg._scene_graph.SceneGraph",
  ...
  {  // graph_name
    ...
    rosidl_generator_c__String__assign(&ros_message->graph_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // graph_root
    PyObject * field = PyObject_GetAttrString(_pymsg, "graph_root");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_generator_c__String__assign(&ros_message->graph_root, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // link_list
    PyObject * field = PyObject_GetAttrString(_pymsg, "link_list");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'link_list'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!tesseract_msgs__msg__Link__Sequence__init(&(ros_message->link_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create tesseract_msgs__msg__Link__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    tesseract_msgs__msg__Link * dest = ros_message->link_list.data;
  ...
  {  // joint_list
    PyObject * field = PyObject_GetAttrString(_pymsg, "joint_list");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'joint_list'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!tesseract_msgs__msg__Joint__Sequence__init(&(ros_message->joint_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create tesseract_msgs__msg__Joint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    tesseract_msgs__msg__Joint * dest = ros_message->joint_list.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * tesseract_msgs__msg__scene_graph__convert_to_py(void * raw_ros_message)
{
  ...
  {  // graph_root
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->graph_root.data,
      strlen(ros_message->graph_root.data),
      "strict");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "graph_root", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // link_list
    PyObject * field = NULL;
    size_t size = ros_message->link_list.size;
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->link_list.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "link_list", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // joint_list
    PyObject * field = NULL;
    size_t size = ros_message->joint_list.size;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->joint_list.data[i]);
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "joint_list", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
