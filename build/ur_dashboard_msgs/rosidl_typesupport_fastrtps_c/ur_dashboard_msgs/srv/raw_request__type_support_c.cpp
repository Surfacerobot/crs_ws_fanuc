...
#include "rosidl_generator_c/string.h"  // query
#include "rosidl_generator_c/string_functions.h"  // query
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: query
  {
    const rosidl_generator_c__String * str = &ros_message->query;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: query
  {
    ...
    if (!ros_message->query.data) {
      rosidl_generator_c__String__init(&ros_message->query);
    }
