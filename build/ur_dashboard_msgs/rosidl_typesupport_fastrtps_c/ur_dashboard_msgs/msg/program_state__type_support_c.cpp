...
#include "ur_dashboard_msgs/msg/program_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // state
#include "rosidl_generator_c/string_functions.h"  // state
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: state
  {
    const rosidl_generator_c__String * str = &ros_message->state;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: state
  {
    ...
    if (!ros_message->state.data) {
      rosidl_generator_c__String__init(&ros_message->state);
    }
