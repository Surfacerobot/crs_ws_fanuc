...
bool crs_msgs__srv__crop_toolpaths__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "crs_msgs.srv._crop_toolpaths.CropToolpaths_Request",
        full_classname_dest, 50) == 0);
  }
  crs_msgs__srv__CropToolpaths_Request * ros_message = _ros_message;
  {  // images
  ...
  {  // toolpaths
    PyObject * field = PyObject_GetAttrString(_pymsg, "toolpaths");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'toolpaths'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    crs_msgs__msg__ToolProcessPath * dest = ros_message->toolpaths.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of CropToolpaths_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("crs_msgs.srv._crop_toolpaths");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CropToolpaths_Request");
  ...
  {  // toolpaths
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->toolpaths.data[i]);
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "toolpaths", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool crs_msgs__srv__crop_toolpaths__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "crs_msgs.srv._crop_toolpaths.CropToolpaths_Response",
        full_classname_dest, 51) == 0);
  }
  crs_msgs__srv__CropToolpaths_Response * ros_message = _ros_message;
  {  // cropped_toolpaths
    PyObject * field = PyObject_GetAttrString(_pymsg, "cropped_toolpaths");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'cropped_toolpaths'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    crs_msgs__msg__ToolProcessPath * dest = ros_message->cropped_toolpaths.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!crs_msgs__msg__tool_process_path__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of CropToolpaths_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("crs_msgs.srv._crop_toolpaths");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CropToolpaths_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // cropped_toolpaths
    ...
    crs_msgs__msg__ToolProcessPath * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->cropped_toolpaths.data[i]);
      PyObject * pyitem = crs_msgs__msg__tool_process_path__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "cropped_toolpaths", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
