...
#ifndef OCTOMAP_MSGS__MSG__OCTOMAP__STRUCT_HPP_
#define OCTOMAP_MSGS__MSG__OCTOMAP__STRUCT_HPP_
...
struct Octomap_
{
  ...
  explicit Octomap_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
  ...
  explicit Octomap_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    id(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // OCTOMAP_MSGS__MSG__OCTOMAP__STRUCT_HPP_
