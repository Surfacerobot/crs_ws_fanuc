...
#include "ur_dashboard_msgs/srv/get_program_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // answer, program_name
#include "rosidl_generator_c/string_functions.h"  // answer, program_name
#include "ur_dashboard_msgs/msg/program_state__functions.h"  // state
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->program_name;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: program_name
  {
    ...
    if (!ros_message->program_name.data) {
      rosidl_generator_c__String__init(&ros_message->program_name);
    }
