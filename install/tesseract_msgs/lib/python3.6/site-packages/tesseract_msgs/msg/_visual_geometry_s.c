...
bool tesseract_msgs__msg__visual_geometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tesseract_msgs.msg._visual_geometry.VisualGeometry",
        full_classname_dest, 50) == 0);
  }
  tesseract_msgs__msg__VisualGeometry * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of VisualGeometry */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tesseract_msgs.msg._visual_geometry");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VisualGeometry");
  ...
  tesseract_msgs__msg__VisualGeometry * ros_message = (tesseract_msgs__msg__VisualGeometry *)raw_ros_message;
  {  // name
    PyObject * field = NULL;
