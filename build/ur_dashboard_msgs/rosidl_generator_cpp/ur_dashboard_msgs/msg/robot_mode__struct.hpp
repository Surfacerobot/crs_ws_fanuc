...
#ifndef UR_DASHBOARD_MSGS__MSG__ROBOT_MODE__STRUCT_HPP_
#define UR_DASHBOARD_MSGS__MSG__ROBOT_MODE__STRUCT_HPP_
...
struct RobotMode_
{
  ...
  explicit RobotMode_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit RobotMode_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // UR_DASHBOARD_MSGS__MSG__ROBOT_MODE__STRUCT_HPP_
