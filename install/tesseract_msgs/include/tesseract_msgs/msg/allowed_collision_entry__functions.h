...
#ifndef TESSERACT_MSGS__MSG__ALLOWED_COLLISION_ENTRY__FUNCTIONS_H_
#define TESSERACT_MSGS__MSG__ALLOWED_COLLISION_ENTRY__FUNCTIONS_H_
 ...
 * calls
 * tesseract_msgs__msg__AllowedCollisionEntry__init().
...
/**
 * It calls
 * tesseract_msgs__msg__AllowedCollisionEntry__fini()
 ...
 * tesseract_msgs__msg__AllowedCollisionEntry__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * tesseract_msgs__msg__AllowedCollisionEntry__Sequence__fini()
 * on the array,
...
#endif  // TESSERACT_MSGS__MSG__ALLOWED_COLLISION_ENTRY__FUNCTIONS_H_
