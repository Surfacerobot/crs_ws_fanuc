...
bool region_detection_msgs__msg__pose_set__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "region_detection_msgs.msg._pose_set.PoseSet",
        full_classname_dest, 43) == 0);
  }
  region_detection_msgs__msg__PoseSet * ros_message = _ros_message;
  {  // pose_arrays
    PyObject * field = PyObject_GetAttrString(_pymsg, "pose_arrays");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'pose_arrays'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    geometry_msgs__msg__PoseArray * dest = ros_message->pose_arrays.data;
...
{
  /* NOTE(esteve): Call constructor of PoseSet */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("region_detection_msgs.msg._pose_set");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoseSet");
  ...
  {  // pose_arrays
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->pose_arrays.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "pose_arrays", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
