...
{
  return max_serialized_size_octomap_msgs__srv__GetOctomap_Request(
    full_bounded, 0);
}
...
#include "octomap_msgs/msg/octomap__functions.h"  // map
...
{
  return max_serialized_size_octomap_msgs__srv__GetOctomap_Response(
    full_bounded, 0);
}
