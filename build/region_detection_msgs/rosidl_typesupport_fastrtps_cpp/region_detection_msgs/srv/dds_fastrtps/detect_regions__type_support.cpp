...
#include "region_detection_msgs/srv/detect_regions__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const region_detection_msgs::srv::DetectRegions_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  region_detection_msgs::srv::DetectRegions_Request & ros_message)
{
  // Member: images
  {
    uint32_t cdrSize;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_region_detection_msgs
max_serialized_size_DetectRegions_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const region_detection_msgs::srv::DetectRegions_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<region_detection_msgs::srv::DetectRegions_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DetectRegions_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const region_detection_msgs::srv::DetectRegions_Request *>(
...
{
  return max_serialized_size_DetectRegions_Request(full_bounded, 0);
}

static message_type_support_callbacks_t _DetectRegions_Request__callbacks = {
...
static rosidl_message_type_support_t _DetectRegions_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectRegions_Request__callbacks,
...
{
  return &region_detection_msgs::srv::typesupport_fastrtps_cpp::_DetectRegions_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, region_detection_msgs, srv, DetectRegions_Request)() {
  return &region_detection_msgs::srv::typesupport_fastrtps_cpp::_DetectRegions_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_region_detection_msgs
cdr_serialize(
  const region_detection_msgs::srv::DetectRegions_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: detected_regions
  {
    ...
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.detected_regions[i],
        cdr);
    }
  }
  // Member: succeeded
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  region_detection_msgs::srv::DetectRegions_Response & ros_message)
{
  // Member: detected_regions
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.detected_regions.resize(size);
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.detected_regions[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: detected_regions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        geometry_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.detected_regions[index], current_alignment);
    }
  }
  // Member: succeeded
  {
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_region_detection_msgs
max_serialized_size_DetectRegions_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const region_detection_msgs::srv::DetectRegions_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<region_detection_msgs::srv::DetectRegions_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DetectRegions_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const region_detection_msgs::srv::DetectRegions_Response *>(
...
{
  return max_serialized_size_DetectRegions_Response(full_bounded, 0);
}

static message_type_support_callbacks_t _DetectRegions_Response__callbacks = {
  "region_detection_msgs::srv",
...
static rosidl_message_type_support_t _DetectRegions_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectRegions_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &region_detection_msgs::srv::typesupport_fastrtps_cpp::_DetectRegions_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, region_detection_msgs, srv, DetectRegions_Response)() {
  return &region_detection_msgs::srv::typesupport_fastrtps_cpp::_DetectRegions_Response__handle;
}
...
static service_type_support_callbacks_t _DetectRegions__callbacks = {
  "region_detection_msgs::srv",
  "DetectRegions",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, region_detection_msgs, srv, DetectRegions_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, region_detection_msgs, srv, DetectRegions_Response)(),
...
static rosidl_service_type_support_t _DetectRegions__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectRegions__callbacks,
...
{
  return &region_detection_msgs::srv::typesupport_fastrtps_cpp::_DetectRegions__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, region_detection_msgs, srv, DetectRegions)() {
  return &region_detection_msgs::srv::typesupport_fastrtps_cpp::_DetectRegions__handle;
}
