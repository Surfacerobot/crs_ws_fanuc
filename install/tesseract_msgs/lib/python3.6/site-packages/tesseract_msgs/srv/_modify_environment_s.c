...
bool tesseract_msgs__srv__modify_environment__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tesseract_msgs.srv._modify_environment.ModifyEnvironment_Request",
        full_classname_dest, 64) == 0);
  }
  tesseract_msgs__srv__ModifyEnvironment_Request * ros_message = _ros_message;
  {  // id
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * tesseract_msgs__srv__modify_environment__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ModifyEnvironment_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tesseract_msgs.srv._modify_environment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModifyEnvironment_Request");
  ...
  tesseract_msgs__srv__ModifyEnvironment_Request * ros_message = (tesseract_msgs__srv__ModifyEnvironment_Request *)raw_ros_message;
  {  // id
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool tesseract_msgs__srv__modify_environment__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tesseract_msgs.srv._modify_environment.ModifyEnvironment_Response",
        full_classname_dest, 65) == 0);
  }
  tesseract_msgs__srv__ModifyEnvironment_Response * ros_message = _ros_message;
  {  // success
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * tesseract_msgs__srv__modify_environment__response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ModifyEnvironment_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tesseract_msgs.srv._modify_environment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModifyEnvironment_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  tesseract_msgs__srv__ModifyEnvironment_Response * ros_message = (tesseract_msgs__srv__ModifyEnvironment_Response *)raw_ros_message;
  {  // success
    PyObject * field = NULL;
