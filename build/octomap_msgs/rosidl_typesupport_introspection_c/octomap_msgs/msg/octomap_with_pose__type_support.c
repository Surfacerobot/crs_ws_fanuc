...
void OctomapWithPose__rosidl_typesupport_introspection_c__OctomapWithPose_init_function(
...
void OctomapWithPose__rosidl_typesupport_introspection_c__OctomapWithPose_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers OctomapWithPose__rosidl_typesupport_introspection_c__OctomapWithPose_message_members = {
  ...
  OctomapWithPose__rosidl_typesupport_introspection_c__OctomapWithPose_init_function,  // function to initialize message memory (memory has to be allocated)
  OctomapWithPose__rosidl_typesupport_introspection_c__OctomapWithPose_fini_function  // function to terminate message instance (will not free memory)
};
