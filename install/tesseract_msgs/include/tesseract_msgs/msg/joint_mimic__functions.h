...
#ifndef TESSERACT_MSGS__MSG__JOINT_MIMIC__FUNCTIONS_H_
#define TESSERACT_MSGS__MSG__JOINT_MIMIC__FUNCTIONS_H_
...
#endif  // TESSERACT_MSGS__MSG__JOINT_MIMIC__FUNCTIONS_H_
