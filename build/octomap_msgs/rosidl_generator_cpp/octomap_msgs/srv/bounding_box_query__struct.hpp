...
#ifndef OCTOMAP_MSGS__SRV__BOUNDING_BOX_QUERY__STRUCT_HPP_
#define OCTOMAP_MSGS__SRV__BOUNDING_BOX_QUERY__STRUCT_HPP_
...
struct BoundingBoxQuery_Request_
{
  ...
  explicit BoundingBoxQuery_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : min(_init),
    max(_init)
  {
    (void)_init;
  ...
  explicit BoundingBoxQuery_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : min(_alloc, _init),
    max(_alloc, _init)
  {
    (void)_init;
...
struct BoundingBoxQuery_Response_
{
  ...
  explicit BoundingBoxQuery_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit BoundingBoxQuery_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // OCTOMAP_MSGS__SRV__BOUNDING_BOX_QUERY__STRUCT_HPP_
