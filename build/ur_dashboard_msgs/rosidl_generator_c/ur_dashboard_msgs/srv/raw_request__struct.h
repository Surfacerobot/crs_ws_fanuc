...
#ifndef UR_DASHBOARD_MSGS__SRV__RAW_REQUEST__STRUCT_H_
#define UR_DASHBOARD_MSGS__SRV__RAW_REQUEST__STRUCT_H_
...
{
  rosidl_generator_c__String query;
...
#endif  // UR_DASHBOARD_MSGS__SRV__RAW_REQUEST__STRUCT_H_
