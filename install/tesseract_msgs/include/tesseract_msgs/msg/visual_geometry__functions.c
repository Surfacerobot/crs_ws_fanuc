...
tesseract_msgs__msg__VisualGeometry__init(tesseract_msgs__msg__VisualGeometry * msg)
{
  ...
  if (!rosidl_generator_c__String__init(&msg->name)) {
    tesseract_msgs__msg__VisualGeometry__fini(msg);
    return false;
  }
  // origin
...
{
  tesseract_msgs__msg__VisualGeometry * msg = (tesseract_msgs__msg__VisualGeometry *)malloc(sizeof(tesseract_msgs__msg__VisualGeometry));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tesseract_msgs__msg__VisualGeometry));
  bool success = tesseract_msgs__msg__VisualGeometry__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
tesseract_msgs__msg__VisualGeometry__Sequence__init(tesseract_msgs__msg__VisualGeometry__Sequence * array, size_t size)
{
  ...
  tesseract_msgs__msg__VisualGeometry * data = NULL;
  if (size) {
    data = (tesseract_msgs__msg__VisualGeometry *)calloc(size, sizeof(tesseract_msgs__msg__VisualGeometry));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tesseract_msgs__msg__VisualGeometry__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tesseract_msgs__msg__VisualGeometry__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
tesseract_msgs__msg__VisualGeometry__Sequence__fini(tesseract_msgs__msg__VisualGeometry__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tesseract_msgs__msg__VisualGeometry__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  tesseract_msgs__msg__VisualGeometry__Sequence * array = (tesseract_msgs__msg__VisualGeometry__Sequence *)malloc(sizeof(tesseract_msgs__msg__VisualGeometry__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = tesseract_msgs__msg__VisualGeometry__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    tesseract_msgs__msg__VisualGeometry__Sequence__fini(array);
  }
  free(array);
}
