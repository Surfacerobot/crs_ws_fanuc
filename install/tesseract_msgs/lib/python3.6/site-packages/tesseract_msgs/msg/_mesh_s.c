...
bool tesseract_msgs__msg__mesh__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tesseract_msgs.msg._mesh.Mesh",
        full_classname_dest, 29) == 0);
  }
  tesseract_msgs__msg__Mesh * ros_message = _ros_message;
  {  // vertices
  ...
  {  // faces
    ...
    if (!rosidl_generator_c__uint32__Sequence__init(&(ros_message->faces), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create uint32__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    uint32_t * dest = ros_message->faces.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // file_path
    ...
    rosidl_generator_c__String__assign(&ros_message->file_path, PyBytes_AS_STRING(encoded_field));
...
PyObject * tesseract_msgs__msg__mesh__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tesseract_msgs.msg._mesh");
  ...
  tesseract_msgs__msg__Mesh * ros_message = (tesseract_msgs__msg__Mesh *)raw_ros_message;
  {  // vertices
    PyObject * field = NULL;
  ...
  {  // faces
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "faces");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->faces.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint32_t * src = &(ros_message->faces.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->faces.size * sizeof(uint32_t));
      assert(data != NULL);
  ...
  {  // scale
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "scale");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
