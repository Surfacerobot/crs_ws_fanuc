...
class Metaclass_Trajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if TesseractState.__class__._TYPE_SUPPORT is None:
                TesseractState.__class__.__import_type_support__()
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        'tesseract_state': 'tesseract_msgs/TesseractState',
        'joint_trajectory': 'trajectory_msgs/JointTrajectory',
        'multi_dof_joint_trajectory': 'trajectory_msgs/MultiDOFJointTrajectory',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['tesseract_msgs', 'msg'], 'TesseractState'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from tesseract_msgs.msg import TesseractState
        self.tesseract_state = kwargs.get('tesseract_state', TesseractState())
        from trajectory_msgs.msg import JointTrajectory
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.tesseract_state != other.tesseract_state:
            return False
    ...
    @property
    def tesseract_state(self):
        """Message field 'tesseract_state'."""
        return self._tesseract_state

    @tesseract_state.setter
    def tesseract_state(self, value):
        if __debug__:
            from tesseract_msgs.msg import TesseractState
            assert \
                isinstance(value, TesseractState), \
                "The 'tesseract_state' field must be a sub message of type 'TesseractState'"
        self._tesseract_state = value
