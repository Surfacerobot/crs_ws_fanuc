...
{
  tesseract_msgs__srv__GetEnvironmentChanges_Request * msg = (tesseract_msgs__srv__GetEnvironmentChanges_Request *)malloc(sizeof(tesseract_msgs__srv__GetEnvironmentChanges_Request));
  if (!msg) {
    return NULL;
  }
...
tesseract_msgs__srv__GetEnvironmentChanges_Request__Sequence__init(tesseract_msgs__srv__GetEnvironmentChanges_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tesseract_msgs__srv__GetEnvironmentChanges_Request *)calloc(size, sizeof(tesseract_msgs__srv__GetEnvironmentChanges_Request));
    if (!data) {
      return false;
    }
...
{
  tesseract_msgs__srv__GetEnvironmentChanges_Request__Sequence * array = (tesseract_msgs__srv__GetEnvironmentChanges_Request__Sequence *)malloc(sizeof(tesseract_msgs__srv__GetEnvironmentChanges_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  tesseract_msgs__srv__GetEnvironmentChanges_Response * msg = (tesseract_msgs__srv__GetEnvironmentChanges_Response *)malloc(sizeof(tesseract_msgs__srv__GetEnvironmentChanges_Response));
  if (!msg) {
    return NULL;
  }
...
tesseract_msgs__srv__GetEnvironmentChanges_Response__Sequence__init(tesseract_msgs__srv__GetEnvironmentChanges_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tesseract_msgs__srv__GetEnvironmentChanges_Response *)calloc(size, sizeof(tesseract_msgs__srv__GetEnvironmentChanges_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  tesseract_msgs__srv__GetEnvironmentChanges_Response__Sequence * array = (tesseract_msgs__srv__GetEnvironmentChanges_Response__Sequence *)malloc(sizeof(tesseract_msgs__srv__GetEnvironmentChanges_Response__Sequence));
  if (!array) {
    return NULL;
  }
