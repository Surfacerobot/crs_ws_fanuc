...
bool crs_msgs__msg__tool_process_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "crs_msgs.msg._tool_process_path.ToolProcessPath",
        full_classname_dest, 47) == 0);
  }
  crs_msgs__msg__ToolProcessPath * ros_message = _ros_message;
  {  // rasters
    PyObject * field = PyObject_GetAttrString(_pymsg, "rasters");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'rasters'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    geometry_msgs__msg__PoseArray * dest = ros_message->rasters.data;
...
{
  /* NOTE(esteve): Call constructor of ToolProcessPath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("crs_msgs.msg._tool_process_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ToolProcessPath");
  ...
  {  // rasters
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->rasters.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "rasters", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
