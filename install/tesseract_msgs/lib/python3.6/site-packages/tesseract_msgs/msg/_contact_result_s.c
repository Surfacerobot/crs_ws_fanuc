...
bool tesseract_msgs__msg__contact_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tesseract_msgs.msg._contact_result.ContactResult",
  ...
  {  // link_names
    ...
    Py_ssize_t size = 2;
    rosidl_generator_c__String * dest = ros_message->link_names;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * tesseract_msgs__msg__contact_result__convert_to_py(void * raw_ros_message)
{
  ...
  {  // link_names
    PyObject * field = NULL;
    size_t size = 2;
    rosidl_generator_c__String * src = ros_message->link_names;
