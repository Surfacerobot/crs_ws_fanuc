...
bool tesseract_msgs__msg__joint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tesseract_msgs.msg._joint.Joint",
  ...
  {  // child_link_name
    ...
    rosidl_generator_c__String__assign(&ros_message->child_link_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // parent_link_name
    ...
    rosidl_generator_c__String__assign(&ros_message->parent_link_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
